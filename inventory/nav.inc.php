<table width="100%" cellpadding="3">
    ...
    ?>
        ...
        <tr>
            <td><img src="images/home.jpg" alt="Categories Icon" width="12" height="12">&nbsp;
        ...
        <tr>
            <td><img src="images/home.jpg" alt="Items Icon" width="12" height="12">&nbsp;
                <strong>Items</strong>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td><a href="index.php?content=logout">
                    <img src="images/home.jpg" alt="Logout Icon" width="12" height="12"></a>&nbsp;
